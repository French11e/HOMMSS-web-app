...
export default function SignInModal({ onClose, onSwitch, onForgotPassword }) {
  const navigate = useNavigate(); // React Router navigation

  // Handle forgot password click (redirect or modal)
        ...
        <div className="space-y-5">
          ...
          <form className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <button
                onClick={handleForgotPassword} // Redirect or open modal
